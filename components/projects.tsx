...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-1765087452015-1765087453602.png","video":"","title":"1인 가구 증가가 지역 주거시장에 미치는 영향 분석","description":"최근 대한민국은 전체 가구 중 1인 가구 비중이 30%를 넘어서는 등 급속한 가구 구조 변화를 겪고 있다. 1인 가구의 증가는 단순한 인구학적 현상을 넘어 주택 수요 구조, 임대시장, 지역 상권 등 다양한 영역에서 새로운 정책적 요구를 발생시키고 있으며, 특히 도심의 청년층 1인 가구와 지방의 중·장년층 1인 가구는 상이한 주거 특성을 보여 지역 간 주거 안정성 격차를 확대시키고 있다. 본 연구는 이러한 변화가 지역 주거시장에 미치는 구조적 영향을 분석하는 데 목적을 두었다. 통계청 자료와 국토교통부 실거래가 등의 데이터를 활용하여 1인 가구 비율에 따른 주택 가격, 전월세 수준, 공실률을 비교한 결과, 1인 가구 비중이 높은 지역에서는 소형 주택 가격 상승이 뚜렷하게 나타났으며, 반대로 지방 중소도시에서는 공실률 증가가 두드러졌다. 이는 지역 특성에 맞춘 주거 공급 전략과 주거비 완화 정책이 필요함을 시사한다.\n"},{"image":"/uploads/project-1765087564667-1765087564840.png","video":"","title":"국내 지방 소멸 현상의 문제점과 해결방안 -부동산 시장 불균형 문제를 중심으로","description":"대한민국은 저출산·고령화와 수도권 집중이라는 구조적 문제 속에서 지방 인구 감소가 빠르게 진행되고 있다. 실제로 2023년 기준 전국 시·군·구의 절반 이상이 소멸위험지역으로 분류될 만큼 지방 소멸은 심각한 사회적 이슈로 부상했다. 지방의 청년층이 수도권으로 지속적으로 이동하면서 지역 공동체는 붕괴되고 학교·병원·상점 등 필수 인프라의 유지조차 어려운 상황이 나타나고 있다. 이러한 인구 변화는 부동산 시장의 양극화와도 직결된다. 수도권은 과잉 수요로 주택 가격이 꾸준히 상승하는 반면, 지방은 수요 부족으로 주거 및 상업용 부동산 모두 침체를 겪고 있다. 본 연구는 지방 소멸과 부동산 시장 불균형이 어떤 방식으로 상호작용하는지 분석하고, 균형 발전 관점에서 해결 방안을 모색하는 것을 목적으로 한다. 이를 위해 통계 자료와 선행 연구를 활용해 지방 소멸의 원인과 시장 구조 변화를 검토하고, 해외 사례를 바탕으로 한국 부동산 정책의 시사점을 도출했다.\n"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
